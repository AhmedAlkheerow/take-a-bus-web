    ...
    <div>
      <div className="mt-4">
        <button
          ...
          type="button"
          className="flex items-center rounded-lg py-2 bg-transparent text-black border-solid border-2 border-gray-500 hover:bg-gray-200 md:w-full sm:w-auto sm:pr-8"
        >
          <img
            src={GoogleIcon}
